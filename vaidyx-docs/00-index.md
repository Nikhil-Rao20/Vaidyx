# Vaidyx Codebase Documentation — Master Index
...
It serves as the knowledge base for understanding and modifying the Vaidyx platform.
...
`Package.swift` (swift-tools-version 6.2), `VaidyxMLXColorize` (DDColor, float16 Metal),
`VaidyxMLXInpaint` (LaMa/MI-GAN), Python integration via subprocess.
...
20+ `vaidyx-*` CLI scripts, shell completion, demo email scripts, 12 standalone utilities.
