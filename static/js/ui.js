...
function _initHoverCardSpaceToggle() {
  if (document._vaidyxHoverCardSpaceToggle) return;
  document._vaidyxHoverCardSpaceToggle = true;
...
export function showToast(msg, durationOrOpts) {
  ...
  if (actionLabel && onAction) {
    ...
    if (actionHint && window.innerWidth > 768) {
      ...
      hint.style.cssText = "font-size:9px;opacity:0.55;letter-spacing:0.4px;text-transform:uppercase;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,'Elms Sans',monospace;margin-top:1px;pointer-events:none;";
