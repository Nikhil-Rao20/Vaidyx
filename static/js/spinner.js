...
class Spinner {
  ...
  createElement() {
    ...
    span.style.cssText = "font-family: 'Elms Sans', monospace; white-space: pre;";
    this.element = span;
    this.updateDisplay();
    return span;
  }
  ...
  _createSineWaveElement() {
    ...
    wrapper.style.cssText = "font-family: 'Elms Sans', monospace; white-space: pre; display: inline-flex; align-items: center; gap: 6px;";
