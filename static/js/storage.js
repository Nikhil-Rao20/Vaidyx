...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'vaidyx-model-expanded',
  MODEL_ENDPOINTS: 'vaidyx-model-endpoints',
  MODEL_SELECTED: 'vaidyx-selected-model',
  SORT_ORDER: 'vaidyx-sessions-sort',
  CHAT_SEARCH_SCOPE: 'vaidyx-search-scope',
  INCOGNITO: 'vaidyx-incognito',
  RAG_ACTIVE: 'vaidyx-rag-active',
  MCP_ACTIVE: 'vaidyx-mcp-active',
  SECTION_ORDER: 'sidebar-section-order',
  ADMIN_LAST_TAB: 'admin-last-tab',
  DENSITY: 'vaidyx-density',
  UI_SCALE: 'vaidyx-ui-scale',
  WORKSPACE: 'vaidyx-workspace'
};
