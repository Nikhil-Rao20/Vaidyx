"""scripts/_lib/cli.py — shared scaffolding for the `vaidyx-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("vaidyx-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/vaidyx-foo`
...
VERSION = "0.1.0"  # bumped centrally; every vaidyx-* CLI reports this
