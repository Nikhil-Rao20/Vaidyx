...
# external data (calendar events, notes, etc.). This cache
...
class TaskScheduler:
        ...
        try:
            ...
            if gate_foreground:
                ...
                if waiting and waiting.status == "queued":
                    waiting.result = "Queued — waiting for Vaidyx to be idle…"
                    db.commit()
                ...
                async def _cancel_if_foreground_active():
                    ...
                    while True:
                        ...
                        if has_foreground_activity():
                            ...
                            logger.info("Task '%s' interrupted because Vaidyx became active", task.name)
                            if current_task:
                                current_task.cancel()
                            return
            ...
            try:
                ...
                msg = (
                    "Paused because Vaidyx became active"
    ...
    async def stop_background_tasks_for_foreground(self, *, reason: str = "Vaidyx became active") -> int:
        ...
        user opens or uses Vaidyx, foreground interaction wins immediately.
