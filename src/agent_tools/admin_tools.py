...
migration (#3629, the `admin_tools.py` bullet): manage_endpoints /
manage_settings. Each impl keeps its `do_*(content, owner)` shape;
            ...
            if action == "list_tools":
                ...
                return {
                    "response": (
                        ...
                        "Common toggles: search (web_search), browser, documents, "
                        "memory, skills, tasks, notes, calendar."
                    ),
