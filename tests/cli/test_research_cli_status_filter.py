"""`vaidyx-research list --status complete` was returning nothing.
...
Part of #2122 (vaidyx-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "vaidyx-research"
    loader = importlib.machinery.SourceFileLoader("vaidyx_research_cli", str(path))
