"""cmd_add (scripts/vaidyx-memory) must tolerate a non-dict row in the
...
def _load_cli(monkeypatch):
    ...
    path = ROOT / "scripts" / "vaidyx-memory"
    loader = importlib.machinery.SourceFileLoader("vaidyx_memory_cli_add", str(path))
