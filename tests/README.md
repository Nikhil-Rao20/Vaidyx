...
```text
[order-report] working directory: /path/to/vaidyx
...
[order-report] reproduce with: /path/to/vaidyx/venv/bin/python /path/to/vaidyx/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
