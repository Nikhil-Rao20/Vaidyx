...
def build_uploaded_file_manifest(att_ids: list, upload_handler, owner: Optional[str]) -> list[dict]:
    ...
    for att_id in att_ids:
        ...
        ref.update({
            ...
            "uri": f"vaidyx://attachment/{ref['attachment_id']}",
...
def fire_message_event(request, session_id: str, sess, message: str, compare_mode: bool = False):
...
async def build_chat_context(
    ...
    # Fire events
    if not incognito:
        fire_message_event(request, session_id, sess, message, compare_mode)
